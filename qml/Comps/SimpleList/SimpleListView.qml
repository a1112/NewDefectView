...
Item {
    ...
    width: 600
    property int idWidth: root.width*0.15
    property int steelWidth_: root.width*0.25

    property int timeWidth: root.width*0.2
    property int  steelTypeWidth: root.width*0.15
    property real steelLength_: root.width*0.25
    height: col.height
